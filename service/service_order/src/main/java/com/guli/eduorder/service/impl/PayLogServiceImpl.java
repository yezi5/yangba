...
import com.guli.eduorder.util.HttpClient;
...
public class PayLogServiceImpl extends ServiceImpl<PayLogMapper, PayLog> implements PayLogService {
    ...
    public void updateOrderStatus(Map<String, String> map) {
        ...
        order.setStatus(1);
        order.setPayType(Integer.parseInt(map.get("paytype")));
    ...
    @Override
    public PayLog getOne(QueryWrapper<PayLog> wrapper) {
        PayLog payLog = baseMapper.selectOne(wrapper);
